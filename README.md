...
<img alt="GitHub Repo stars" src="https://img.shields.io/github/stars/ConardLi/triple-harmony-entropy-motion">
<img alt="GitHub Downloads (all assets, all releases)" src="https://img.shields.io/github/downloads/ConardLi/triple-harmony-entropy-motion/total">
<img alt="GitHub Release" src="https://img.shields.io/github/v/release/ConardLi/triple-harmony-entropy-motion">
<img src="https://img.shields.io/badge/license-AGPL--3.0-green.svg" alt="AGPL 3.0 License"/>
<img alt="GitHub contributors" src="https://img.shields.io/github/contributors/ConardLi/triple-harmony-entropy-motion">
<img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/ConardLi/triple-harmony-entropy-motion">
...
<a href="https://trendshift.io/repositories/13944" target="_blank"><img src="https://trendshift.io/api/badge/repositories/13944" alt="ConardLi%2Ftriple-harmony-entropy-motion | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>

**A powerful tool for creating fine-tuning datasets for Large Language Models**

[简体中文](./README.zh-CN.md) | [English](./README.md)

[Features](#features) • [Quick Start](#local-run) • [Documentation](https://docs.triple-harmony-entropy-motion.com/en) • [Contributing](#contributing) • [License](#license)
...
Triple Harmony Entropy Motion is an application specifically designed for creating fine-tuning datasets for Large Language Models (LLMs). It provides an intuitive interface for uploading domain-specific files, intelligently splitting content, generating questions, and producing high-quality training data for model fine-tuning.

With Triple Harmony Entropy Motion, you can transform domain knowledge into structured datasets, compatible with all LLM APIs that follow the OpenAI format, making the fine-tuning process simple and efficient.
...
<table style="width: 100%">
  ...
  <tr style="text-align: center">
    <td align="center" valign="middle">
      <a href='https://github.com/ConardLi/triple-harmony-entropy-motion/releases/latest'>
...
```bash
   git clone https://github.com/ConardLi/triple-harmony-entropy-motion.git
   cd triple-harmony-entropy-motion
```
...
services:
  triple-harmony-entropy-motion:
    image: ghcr.io/conardli/triple-harmony-entropy-motion
    container_name: triple-harmony-entropy-motion
    ports:
      - '1717:1717'
    volumes:
...
docker run -d \
  ...
  --name triple-harmony-entropy-motion \
      triple-harmony-entropy-motion
```
...
- View the demo video of this project: [Triple Harmony Entropy Motion Demo Video](https://www.bilibili.com/video/BV1y8QpYGE57/)
- For detailed documentation on all features and APIs, visit our [Documentation Site](https://docs.triple-harmony-entropy-motion.com/en)
- View the paper of this project: [Triple Harmony Entropy Motion: A Unified and Extensible Framework for Synthesizing LLM Fine-Tuning Data from Unstructured Documents](https://arxiv.org/abs/2507.04009v1)

## Community Practice

- [Triple Harmony Entropy Motion × LLaMA Factory: Enabling LLMs to Efficiently Learn Domain Knowledge](https://buaa-act.feishu.cn/wiki/GVzlwYcRFiR8OLkHbL6cQpYin7g)
- [Triple Harmony Entropy Motion Practical Guide: How to Build High-Quality Datasets?](https://www.bilibili.com/video/BV1MRMnz1EGW)
- [Interpretation of Key Feature Updates in Triple Harmony Entropy Motion](https://www.bilibili.com/video/BV1fyJhzHEb7/)
- [Foundation Models Fine-tuning Datasets: Basic Knowledge Popularization](https://docs.triple-harmony-entropy-motion.com/knowledge-base)

## Contributing

We welcome contributions from the community! If you'd like to contribute to Triple Harmony Entropy Motion, please follow these steps:
...
https://docs.triple-harmony-entropy-motion.com/contact
...
```bibtex
@misc{miao2025tripleharmonyentropymotion,
  title={Triple Harmony Entropy Motion: A Unified and Extensible Framework for Synthesizing LLM Fine-Tuning Data from Unstructured Documents},
...
[![Star History Chart](https://api.star-history.com/svg?repos=ConardLi/triple-harmony-entropy-motion&type=Date)](https://www.star-history.com/#ConardLi/triple-harmony-entropy-motion&Date)
