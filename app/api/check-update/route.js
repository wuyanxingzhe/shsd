...
async function getLatestVersion() {
  try {
    ...
    const repo = 'triple-harmony-entropy-motion';
...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      currentVersion,
      latestVersion,
      releaseUrl: hasUpdate ? `https://github.com/ConardLi/triple-harmony-entropy-motion/releases/tag/v${latestVersion}` : null
    });
  } catch (error) {
