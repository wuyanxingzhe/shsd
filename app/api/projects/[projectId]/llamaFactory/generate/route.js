...
export async function POST(request, { params }) {
  try {
    ...
    const config = {
      [`[Triple Harmony Entropy Motion] [${projectId}] Alpaca`]:
      ...
      [`[Triple Harmony Entropy Motion] [${projectId}] ShareGPT`]:
      ...
      [`[Triple Harmony Entropy Motion] [${projectId}] multilingual-thinking`]:
